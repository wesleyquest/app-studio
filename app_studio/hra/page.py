...
def hra_main_component() -> rx.Component:
    return rx.vstack(
                ...
                rx.tabs.root(
                    rx.tabs.list(
                        rx.tabs.trigger(
                            rx.text("건강보험 수진내역 선택", size="4", font_family="NotoSansKR-Bold"),
                            value="tab1",
                            width="50%"),
                        rx.tabs.trigger(
                            rx.text("재해조사서 초안 생성", size="4", font_family="NotoSansKR-Bold"), 
                            value="tab2",
                            width="50%"),
                        size="2",
                    ),
                    rx.tabs.content(
                        #rx.text(HRAState.wonbu_no_var),
                        rx.hstack(
